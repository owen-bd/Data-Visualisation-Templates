...
b1 = ax1.bar(x, df['COLUMN 1 OF INVESTIGATION'],width=width, color='#f7ff74', alpha=1, zorder=5, label='LABEL')
# Same thing, but offset the x by the width of the bar.
b2 = ax1.bar(x + width, df['COLUMN 2 OF INVESTIGATION'],width=width, color='#5370ff', alpha=1, zorder=5, label='LABEL')
...
#X label (across)
q = ax1.set_xlabel("HOW WE HAVE SPLIT THE DATA", font=MyFont, fontsize=14, fontweight='bold', color='w')
...
#Setting up a legend
ax1.legend(facecolor='w', prop={'family': MyFont, 'size':12}, framealpha=0.6, edgecolor='k')
...
#Changing x ticks and sorting alignment
