...
#-----------------------------------------------------------------------------------------------------------------------
"""PLOTTING"""
#Plotting the histogram (stacked) - classic histogram
sns.histplot(data=df_new, x='WHAT WE WANT TO MEASURE', hue="COLUMN /// HOW WE ARE SPLITTING THE HISTOGRAMS", palette=('#c2a7ef', '#fb8585', '#0f9d58'), alpha=0.7, multiple="stack", bins=10)

#Placing a rug with it too
sns.rugplot(data=df_new, x='WHAT WE WANT TO MEASURE', hue="COLUMN /// HOW WE ARE SPLITTING THE HISTOGRAMS", palette=('#c2a7ef', '#fb8585','#0f9d58' ), expand_margins=True)
